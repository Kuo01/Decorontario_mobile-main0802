                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Text("\nLight luxury products, make your home more warm.\n"+snapshot.data[index]["type"],textAlign: TextAlign.left,style: TextStyle(fontSize: 17)),
                      Expanded( //此处使用expanded 填充，然后设置container 的对其方式确保 在底部显示
                        child:  Row(
                          children: <Widget>[
                            Container(
                              alignment: Alignment.bottomLeft,//设置container的对其方式
                              child: Text("Price:\$"+snapshot.data[index]["price"],style: TextStyle(color: Colors.red[500],fontSize: 20),),
                            ),
                            Expanded(
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text("Regular Price:\$"+snapshot.data[index]["price"],style: TextStyle(decoration: TextDecoration.lineThrough, color: Colors.green[500],fontSize: 20),),
                                  ],
                                ),
                              ),
                            ),
